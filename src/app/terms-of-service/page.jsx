...
export const metadata = {
    ...
    description: 'Terms of Service for Sleep Unpacked.',
};
        ...
        <>
            ...
            <main className="bg-white min-h-screen pt-32 pb-16">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 className="text-4xl font-bold text-jet-black mb-8">Terms of Service</h1>

                    <div className="prose prose-lg text-jet-black-800 max-w-none space-y-6">
                        <p>This Agreement was last modified on September 24, 2022.</p>
                        <p>
                            Please read these Terms of Service ("Agreement", "Terms of Service") carefully before using this website ("the Site").
                        </p>
                        <p>
                            This Agreement sets forth the legally binding terms and conditions for your use of the Site.
                        </p>
                        <p>
                        ...
                        <h2 className="text-2xl font-semibold text-jet-black mt-8 mb-4">Intellectual Property</h2>
                        <p>
                        ...
                        <h2 className="text-2xl font-semibold text-jet-black mt-8 mb-4">Termination</h2>
                        <p>
                            We may terminate your access to the Site, without cause or notice, which may result in the forfeiture and destruction of all information associated with you. All provisions of this Agreement that by their nature should survive termination shall survive termination, including, without limitation, ownership provisions, warranty disclaimers, indemnity, and limitations of liability.
                        </p>

                        <h2 className="text-2xl font-semibold text-jet-black mt-8 mb-4">Links To Other Sites</h2>
                        <p>
                        ...
                        <h2 className="text-2xl font-semibold text-jet-black mt-8 mb-4">Governing Law</h2>
                        <p>
                        ...
                        <h2 className="text-2xl font-semibold text-jet-black mt-8 mb-4">Changes To This Agreement</h2>
                        <p>
