        ...
        <div className="font-sans text-graphite bg-white min-h-screen">
            ...
            <div className="max-w-7xl mx-auto px-4 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <Link href="/comparisons/casper-vs-purple" className="block bg-white rounded-2xl shadow-sm border border-alabaster-grey overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
                        ...
                        <div className="p-6">
                            ...
                            <div className="mt-4 text-golden-bronze font-semibold text-sm group-hover:translate-x-1 transition-transform inline-flex items-center gap-1">
