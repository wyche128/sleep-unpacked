...
export const metadata = {
    title: "5 Surprising Truths About the WinkBed EcoCloud | SleepUnpacked",
    description: "A deep dive into the engineering reality behind the WinkBed EcoCloud's durability and comfort."
};
...
const FiveTruthsWinkBedEcoCloud = () => {
    return (
        <div className="font-sans text-jet-black bg-white min-h-screen">
            ...
            {/* Hero Section */}
            <header className="bg-jet-black text-white py-16 sm:py-24 relative overflow-hidden">
                ...
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    <div className="inline-flex items-center px-3 py-1 rounded-full border border-golden-bronze bg-transparent text-golden-bronze text-xs font-semibold uppercase tracking-wide mb-6">
                        Engineering Report
                    </div>
                    ...
                    <p className="text-alabaster-grey text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed">
                    ...
                    <div className="mt-8 flex items-center justify-center space-x-2 text-golden-bronze text-sm">
                        <Clock size={16} />
                        <span>10 min read</span>
                        <span className="mx-2 text-alabaster-grey/50">•</span>
            ...
            <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <article className="prose prose-lg prose-stone mx-auto">
                    <div className="text-xl text-jet-black italic border-l-4 border-golden-bronze pl-4 mb-10 bg-white p-4 rounded-r-lg shadow-sm">
                    ...
                    <div className="my-12 border-t border-alabaster-grey"></div>

                    {/* Truth 1 */}
                    <section className="mb-16">
                        <h2 className="flex items-center text-2xl font-bold text-jet-black mb-6 font-serif">
                            <span className="flex items-center justify-center w-8 h-8 bg-golden-bronze text-white rounded-full text-sm font-bold mr-3 flex-shrink-0">1</span>
                            The "Phantom Sag": Failure Without a Trace
                        </h2>
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-alabaster-grey mb-6">
                            ...
                            <blockquote className="bg-alabaster-grey/30 p-4 rounded-lg border-l-4 border-jet-black/30 italic text-jet-black text-sm">
                        ...
                        <div className="text-sm text-graphite flex items-center">
                            <Info size={16} className="text-golden-bronze mr-2 inline" />
                            <span>
                    ...
                    <section className="mb-16">
                        <h2 className="flex items-center text-2xl font-bold text-jet-black mb-6 font-serif">
                            <span className="flex items-center justify-center w-8 h-8 bg-golden-bronze text-white rounded-full text-sm font-bold mr-3 flex-shrink-0">2</span>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-alabaster-grey">
                            ...
                            <ul className="list-disc pl-5 space-y-2 mb-4 text-jet-black">
                    ...
                    <section className="mb-16">
                        <h2 className="flex items-center text-2xl font-bold text-jet-black mb-6 font-serif">
                            <span className="flex items-center justify-center w-8 h-8 bg-golden-bronze text-white rounded-full text-sm font-bold mr-3 flex-shrink-0">3</span>
                        ...
                        <div className="bg-white border-l-4 border-jet-black p-5 rounded-r-lg shadow-sm">
                            <h3 className="font-bold text-jet-black mb-2 flex items-center">
                                <AlertTriangle size={16} className="text-golden-bronze mr-2" />
                                The Risk Factor
                            </h3>
                            <p className="text-jet-black text-sm mb-3 leading-relaxed">
                    ...
                    <section className="mb-16">
                        <h2 className="flex items-center text-2xl font-bold text-jet-black mb-6 font-serif">
                            <span className="flex items-center justify-center w-8 h-8 bg-golden-bronze text-white rounded-full text-sm font-bold mr-3 flex-shrink-0">4</span>
                            The Tale of Two Lifespans
                        </h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {/* Group A */}
                            <div className="bg-white p-5 rounded-xl border border-golden-bronze shadow-sm">
                                <div className="font-bold text-jet-black mb-2">Group A: Success</div>
                                <div className="text-3xl font-bold text-golden-bronze mb-2">6-8+ <span className="text-sm font-normal text-jet-black">years</span></div>
                                <p className="text-sm text-jet-black">
                                    Sleepers under 200 lbs using a rigid, supportive foundation.
                                </p>
                            </div>
                            {/* Group B */}
                            <div className="bg-alabaster-grey/50 p-5 rounded-xl border border-jet-black/20">
                                <div className="font-bold text-jet-black mb-2">Group B: Early Failure</div>
                                <div className="text-3xl font-bold text-jet-black mb-2">2-4 <span className="text-sm font-normal text-jet-black">years</span></div>
                                <p className="text-sm text-jet-black">
                    ...
                    <section className="mb-16">
                        <h2 className="flex items-center text-2xl font-bold text-jet-black mb-6 font-serif">
                            <span className="flex items-center justify-center w-8 h-8 bg-golden-bronze text-white rounded-full text-sm font-bold mr-3 flex-shrink-0">5</span>
                    ...
                    {/* Actionable Advice */}
                    <section className="bg-jet-black text-white rounded-2xl p-8 shadow-xl transform hover:scale-[1.01] transition-transform duration-300 relative overflow-hidden border border-jet-black-800">
                        <div className="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-golden-bronze rounded-full opacity-20 blur-xl"></div>
                        <div className="relative z-10">
                            <h2 className="text-2xl font-bold mb-6 flex items-center text-white font-serif">
                                <CheckCircle size={24} className="text-golden-bronze mr-3" />
                                Actionable Advice for Owners
                            </h2>
                            <div className="grid gap-6">
                                <div className="flex items-start">
                                    <div className="flex-shrink-0 w-8 h-8 bg-jet-black-800 rounded-full flex items-center justify-center mt-1 border border-golden-bronze/30">
                                        <Ruler size={14} className="text-golden-bronze" />
                                    </div>
                                    <div className="ml-4">
                                ...
                                <div className="flex items-start">
                                    <div className="flex-shrink-0 w-8 h-8 bg-jet-black-800 rounded-full flex items-center justify-center mt-1 border border-golden-bronze/30">
                                        <RefreshCw size={14} className="text-golden-bronze" />
                                    </div>
                                    <div className="ml-4">
                                ...
                                <div className="flex items-start">
                                    <div className="flex-shrink-0 w-8 h-8 bg-jet-black-800 rounded-full flex items-center justify-center mt-1 border border-golden-bronze/30">
                                        <Camera size={14} className="text-golden-bronze" />
                                    </div>
                                    <div className="ml-4">
