...
const LeesaLegendMattressReview = () => {
    ...
    return (
        <div className="antialiased bg-white text-[#242f40] font-sans">
            <Header />
            {/* Navigation - In a real app this might be global, but keeping per design */}
            <nav className="bg-white shadow-sm border-b border-[#e5e5e5]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16 items-center">
                        <div className="flex-shrink-0 flex items-center">
                            <span className="text-2xl font-bold text-[#cca43b]">LivingReview</span>
                            <span className="ml-2 text-[#363636] text-sm font-medium">| Leesa Legend Analysis</span>
                        </div>
                        <div className="hidden sm:flex space-x-8">
                            <a href="#anatomy" className="text-[#363636] hover:text-[#cca43b] px-3 py-2 text-sm font-medium">Anatomy</a>
                            <a href="#performance" className="text-[#363636] hover:text-[#cca43b] px-3 py-2 text-sm font-medium">Performance Drift</a>
                            <a href="#compatibility" className="text-[#363636] hover:text-[#cca43b] px-3 py-2 text-sm font-medium">Sleeper Calculator</a>
                            <a href="#warranty" className="text-[#363636] hover:text-[#cca43b] px-3 py-2 text-sm font-medium">Warranty Gap</a>
                        </div>
                    </div>
                </div>
            </nav>
            ...
            <main>
                ...
                <header className="bg-white">
                    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-center">
                        <h1 className="text-4xl font-extrabold text-[#242f40] sm:text-5xl sm:tracking-tight lg:text-6xl">
                            Leesa Legend Hybrid
                        </h1>
                        <p className="mt-4 max-w-2xl mx-auto text-xl text-[#363636]">
                            A deep, evidence-based analysis of the dual-coil hybrid durability over 5 years.
                        </p>
                        <div className="mt-8 flex justify-center gap-4">
                            <div className="bg-[#cca43b]/10 px-4 py-2 rounded-lg border border-[#cca43b]/20">
                                <span className="block text-xs font-semibold text-[#cca43b] uppercase">Construction</span>
                                <span className="block text-lg font-bold text-[#242f40]">Hybrid (12")</span>
                            </div>
                            <div className="bg-[#cca43b]/10 px-4 py-2 rounded-lg border border-[#cca43b]/20">
                                <span className="block text-xs font-semibold text-[#cca43b] uppercase">Primary Risk</span>
                                <span className="block text-lg font-bold text-[#242f40]">Micro-coil Noise/Feel</span>
                            </div>
                            <div className="bg-[#cca43b]/10 px-4 py-2 rounded-lg border border-[#cca43b]/20">
                                <span className="block text-xs font-semibold text-[#cca43b] uppercase">Ideal Life</span>
                                <span className="block text-lg font-bold text-[#242f40]">~6-8 Years</span>
                            </div>
                        </div>
                    </div>
                </header>
                ...
                {/* SECTION 1: ANATOMY */}
                <section id="anatomy" className="py-12 bg-[#e5e5e5]/10">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-10">
                            <h2 className="text-3xl font-extrabold text-[#242f40]">Hybrid Anatomy</h2>
                            <p className="mt-4 text-lg text-[#363636] max-w-3xl mx-auto">
                      ...
                      ${activeLayer === index
                                                ? 'bg-[#cca43b]/10 border-[#cca43b] border-l-8'
                                                : 'bg-[#363636]/10 border-[#363636]/30 hover:scale-102 hover:shadow-md'
                                            }
                      ${index === 2 ? 'h-40 bg-[#e5e5e5] border-gray-300' : ''}
                    `}
                                        onClick={() => setActiveLayer(index)}
                                    >
                                        <div className="text-center">
                                            <span className="block font-bold text-[#242f40]">{layer.title}</span>
                                            <span className="text-sm text-[#363636]">{layer.subtitle}</span>
                                        </div>
                                    </div>
                                ))}
                            </div>
                            ...
                            {/* Layer Details Panel */}
                            <div className="bg-white rounded-xl shadow-lg p-8 border border-[#e5e5e5] h-full flex flex-col justify-center">
                                <h3 className="text-2xl font-bold text-[#242f40] mb-2">
                                    {layers[activeLayer].title}
                                </h3>
                                <div className="w-16 h-1 bg-[#cca43b] mb-4"></div>
                                <p className="text-[#363636] mb-6">
                                    {layers[activeLayer].desc}
                                </p>

                                <div className="bg-[#e5e5e5]/20 rounded-lg p-4 border border-[#e5e5e5]">
                                    <h4 className="font-semibold text-sm text-[#363636] uppercase tracking-wider mb-2">Longevity Factor</h4>
                                    <p className="text-[#242f40] font-medium">
                ...
                <section id="performance" className="py-16 bg-white border-t border-[#e5e5e5]">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-8">
                            <h2 className="text-3xl font-extrabold text-[#242f40]">Performance Drift Analysis</h2>
                            <p className="mt-4 text-lg text-[#363636] max-w-3xl mx-auto">
                        ...
                        <div className="max-w-3xl mx-auto mb-12">
                            ...
                            <input
                                ...
                                className="w-full h-3 bg-[#e5e5e5] rounded-lg appearance-none cursor-pointer accent-[#cca43b]"
                            />
                            <div className="text-center mt-4">
                                <span className="inline-block bg-[#cca43b] text-white px-4 py-1 rounded-full text-sm font-bold">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            <div className="bg-white rounded-xl p-6 border border-[#e5e5e5] shadow-sm">
                                <h3 className="text-lg font-bold text-[#242f40] mb-2 text-center">Performance Profile Shape</h3>
                                <p className="text-sm text-[#363636] text-center mb-6">Visualizing the stability of key attributes.</p>
                            ...
                            <div className="bg-white rounded-xl p-6 border border-[#e5e5e5] shadow-sm">
                                <h3 className="text-lg font-bold text-[#242f40] mb-2 text-center">Risk of Material Failure</h3>
                                <p className="text-sm text-[#363636] text-center mb-6">Includes deep sagging OR cover defects.</p>
                                <div className="relative w-full max-w-[600px] h-[350px] mx-auto">
                        ...
                        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="bg-white p-4 rounded-lg border-l-4 border-[#cca43b] shadow-sm">
                                <h4 className="text-xs font-bold text-gray-400 uppercase">Firmness Feel</h4>
                                <p className="text-lg font-bold text-[#242f40]">{timelineData.insights[timeMachineYear].firmness}</p>
                            </div>
                            <div className="bg-white p-4 rounded-lg border-l-4 border-amber-500 shadow-sm">
                                ...
                                <p className="text-lg font-bold text-[#242f40]">{timelineData.insights[timeMachineYear].risk}</p>
                            </div>
                            <div className="bg-white p-4 rounded-lg border-l-4 border-[#363636] shadow-sm">
                                <h4 className="text-xs font-bold text-gray-400 uppercase">Analyst Note</h4>
                                <p className="text-sm text-[#363636] mt-1">{timelineData.insights[timeMachineYear].note}</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="compatibility" className="py-16 bg-[#e5e5e5]/20">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-10">
                            <h2 className="text-3xl font-extrabold text-[#242f40]">Sleeper Compatibility Calculator</h2>
                        ...
                        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                            <div className="p-8 border-b border-[#e5e5e5]">
                                <h3 className="text-sm font-bold text-[#363636] uppercase tracking-wide mb-4 text-center">Select Sleeper Weight</h3>
                        ...
                        ${sleeperWeight === idx
                                                    ? 'border-[#cca43b] bg-[#cca43b]/10 text-[#242f40]'
                                                    : 'border-[#e5e5e5] text-[#363636] hover:border-[#cca43b] hover:text-[#242f40]'
                                                }`}
                                        >
                                            {profile.label}
                                        </button>
                            ...
                            <div className="p-8 bg-white text-center">
                                <div className={`inline-flex items-center justify-center w-16 h-16 rounded-full ${weightProfiles[sleeperWeight].bg} ${weightProfiles[sleeperWeight].color} mb-4 text-2xl font-bold`}>
                                    {weightProfiles[sleeperWeight].icon}
                                </div>
                                <h3 className="text-2xl font-bold text-[#242f40] mb-2">{weightProfiles[sleeperWeight].verdict}</h3>
                                <p className="text-[#363636] mb-6">
                                    {weightProfiles[sleeperWeight].desc}
                                </p>
                                <div className="inline-block bg-white px-6 py-3 rounded-full border border-[#e5e5e5] shadow-sm text-sm font-medium text-[#363636]">
                ...
                <section id="warranty" className="py-16 bg-white">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h2 className="text-3xl font-extrabold text-[#242f40] mb-6">Warranty & Cover Issues</h2>
                                <div className="prose prose-slate text-[#363636]">
                                    <p className="mb-4">
                                    ...
                                    <ul className="list-disc pl-5 space-y-2 mb-6">
                                        ...
                                        <li><strong>Micro-coil Feel:</strong> Rarely, sleepers can "feel" the transition between foam and coils as the foam ages.</li>
                                    </ul>
                            ...
                            <div className="bg-white rounded-xl p-6 border border-[#e5e5e5] shadow-sm">
                                <h3 className="text-lg font-bold text-[#242f40] mb-4 text-center">Warranty Threshold Visualization</h3>
                                <div className="relative w-full max-w-[600px] h-[350px] mx-auto">
                ...
                <footer className="bg-[#242f40] text-white py-12">
