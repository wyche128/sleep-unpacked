...
const FiveTruthsWinkBed = () => {
    ...
    return (
        <div className="bg-white font-sans text-graphite">
            <Header />
            ...
            <header className="bg-jet-black text-white py-16 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
                    <span className="inline-block py-1 px-3 rounded-full bg-jet-black-800 text-golden-bronze text-sm font-semibold mb-4 border border-jet-black-800/50">MATTRESS REVIEWS</span>
            ...
            <div className="max-w-6xl mx-auto px-4 py-12 flex flex-col lg:flex-row gap-12">
                ...
                <aside className="hidden lg:block w-1/4 relative">
                    <div className="sticky top-24">
                        ...
                        <div className="mt-8 bg-golden-bronze-100/30 p-6 rounded-lg border border-golden-bronze-100/50">
                ...
                <main className="lg:w-3/4 prose prose-lg max-w-none text-graphite">
                    ...
                    <section id="truth-1" className="mb-16">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="bg-golden-bronze-100/50 p-2 rounded-lg text-golden-bronze">
                        ...
                        <blockquote className="border-l-4 border-golden-bronze pl-6 italic text-graphite bg-golden-bronze-100/20 p-6 rounded-r-lg my-8">
                        ...
                        <div className="bg-golden-bronze-100/40 border-l-4 border-golden-bronze p-4 rounded-r text-sm text-jet-black">
                    ...
                    <section id="truth-2" className="mb-16">
                        ...
                        <div className="bg-golden-bronze-100/20 p-6 rounded-lg my-6">
                    ...
                    <section id="truth-5" className="mb-16">
                        ...
                        <div className="grid md:grid-cols-3 gap-6 mt-8">
                            ...
                            {/* Average */}
                            <div className="bg-golden-bronze-100/20 border border-golden-bronze-100 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
                                <div className="text-golden-bronze mb-3">
            ...
            {/* Footer */}
            <footer className="bg-jet-black text-alabaster-grey py-12 border-t border-jet-black-800 mt-12">
                <div className="max-w-6xl mx-auto px-4 text-center">
                    <div className="flex items-center justify-center gap-2 mb-4">
                        <span className="text-xl font-bold text-white tracking-tight">SleepUncovered</span>
                    </div>
                    <p className="text-sm mb-8">Helping you sleep better through honest, data-driven reviews.</p>
                    <div className="flex justify-center space-x-6 mb-8">
                        <a href="#" className="hover:text-white transition-colors">Privacy Policy</a>
                        <a href="#" className="hover:text-white transition-colors">Terms of Service</a>
                        <a href="#" className="hover:text-white transition-colors">Contact Us</a>
                    </div>
                    <p className="text-xs text-alabaster-grey/60">&copy; 2024 SleepUncovered. All rights reserved.</p>
                </div>
            </footer>
        </div>
    );
