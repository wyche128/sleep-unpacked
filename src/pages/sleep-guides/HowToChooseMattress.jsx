...
const HowToChooseMattress = () => {
        ...
        datasets: [
            {
                ...
                data: [8, 6, 9, 7, 9],
                backgroundColor: 'rgba(20, 184, 166, 0.2)', // teal-ish (mapped to bronzey-teal later maybe, sticking to original conceptual colors for distinctness or mapping to brand)
                // Let's use Brand Colors: Hybrid = Golden Bronze, Memory Foam = Graphite, Latex = Alabaster (too light) -> maybe a Teal/Blue for contrast
                // Actually sticking to distinct functional colors is better for charts. 
                // Hybrid: Golden Bronze
                // Foam: Indigo/Graphite
                // Latex: Amber/Orange
    ...
    // We need to override the chart logic to show ONE at a time effectively via the buttons
    // Actually the logic in HTML was toggling hidden. Here we can just filter the datasets or control the 'hidden' prop directly.
    // I mapped 'hidden' prop to the state `visibleDataset`.
        ...
        <div className="bg-white min-h-screen font-sans text-graphite selection:bg-golden-bronze selection:text-white">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
                ...
                <section className="text-center space-y-6 max-w-3xl mx-auto pt-8">
                    <Link to="/sleep-guides" className="inline-flex items-center gap-2 text-golden-bronze font-bold hover:underline mb-4">
