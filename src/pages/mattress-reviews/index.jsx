        ...
        <div className="font-sans text-graphite bg-white min-h-screen">
            ...
            <div className="max-w-7xl mx-auto px-4 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    {/* Purple Card */}
                    <Link to="/mattress-reviews/purple-original" className="group block bg-jet-black rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 border border-white/10 flex flex-col">
                    ...
                    <Link to="/mattress-reviews/brooklyn-bedding-aurora-luxe" className="group block bg-jet-black rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 border border-white/10 flex flex-col">
                    ...
                    {/* WinkBed Card */}
                    <Link to="/mattress-reviews/winkbed-original" className="group block bg-jet-black rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 border border-white/10 flex flex-col">
                    ...
                    {/* Leesa Card */}
                    <Link to="/mattress-reviews/leesa-original" className="group block bg-jet-black rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 border border-white/10 flex flex-col">
                    ...
                    {/* Leesa Legend Card */}
                    <Link to="/mattress-reviews/leesa-legend" className="group block bg-jet-black rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 border border-white/10 flex flex-col">
                    ...
                    <Link to="/mattress-reviews/winkbed-ecocloud-longevity" className="group block bg-jet-black rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 border border-white/10 flex flex-col">
                    ...
                    {/* 5 Truths Card */}
                    <Link to="/mattress-reviews/five-truths-winkbed" className="group block bg-jet-black rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 border border-white/10 flex flex-col">
                    ...
                    <Link to="/mattress-reviews/five-truths-winkbed-ecocloud" className="group block bg-jet-black rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 border border-white/10 flex flex-col">
                    ...
                    <Link to="/mattress-reviews/dreamcloud-luxe-hybrid-longevity" className="group block bg-jet-black rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 border border-white/10 flex flex-col">
                    ...
                    {/* Nectar Classic Card */}
                    <Link to="/mattress-reviews/nectar-classic" className="group block bg-jet-black rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 border border-white/10 flex flex-col">
                    ...
                    <Link to="/mattress-reviews/nectar-premiere" className="group block bg-jet-black rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 border border-white/10 flex flex-col">
                    ...
                    <Link to="/mattress-reviews/winkbed-gravitylux" className="group block bg-jet-black rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 border border-white/10 flex flex-col">
                    ...
                    {/* Helix Plus Card */}
                    <Link to="/mattress-reviews/helix-plus" className="group block bg-jet-black rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 border border-white/10 flex flex-col">
