...
const PurpleMattressReview = () => {
    ...
    useEffect(() => {
        ...
        return () => {
            // Cleanup if needed, though usually safe to leave library loaded
        };
    }, []);
    ...
    useEffect(() => {
        ...
        window.Chart.defaults.borderColor = COLOR_GRID_LINES;
        ...
        if (ctxSagging && ctxFirmness && ctxCooling && ctxWarranty) {
            ...
            // 1. Sagging
            saggingChartRef.current = new window.Chart(ctxSagging, {
                type: 'line',
                data: {
            ...
            // 2. Firmness
            firmnessChartRef.current = new window.Chart(ctxFirmness, {
                type: 'bar',
                data: {
                    labels: ['New', '1 Year', '2 Years', '3 Years', '4 Years', '5 Years'],
                    datasets: [{
            ...
            // 3. Cooling
            coolingChartRef.current = new window.Chart(ctxCooling, {
                type: 'line',
                data: {
                    labels: ['New', '1 Year', '2 Years', '3 Years', '4 Years', '5 Years'],
                    datasets: [{
            ...
            // 4. Warranty
            warrantyChartRef.current = new window.Chart(ctxWarranty, {
                type: 'doughnut',
                data: {
