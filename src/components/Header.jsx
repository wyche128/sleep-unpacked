      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/top-picks" className="text-graphite hover:text-jet-black font-medium transition">Top Picks</Link>
            <Link href="/mattress-reviews" className="text-graphite hover:text-jet-black font-medium transition">Mattress Reviews</Link>
            <Link href="/comparisons" className="text-graphite hover:text-jet-black font-medium transition">Comparisons</Link>
            <Link href="/sleep-guides" className="text-graphite hover:text-jet-black font-medium transition">Sleep Guides</Link>
